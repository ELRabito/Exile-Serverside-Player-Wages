...
*/
{
	...
	if (alive _player) then
	{
		...
		{	
			[_player, "toastRequest", ["ErrorTitleAndText", ["[AeoG] Activity reward",format ["You do not earn Activity rewards in Safezones or Territories!"]]]] call ExileServer_system_network_send_to;
		...
		}else
		{
			...
			{	
				...
				{
					[_player, "toastRequest", ["ErrorTitleAndText", ["[AeoG] Activity reward","You do not get paid for being an unrespected rat!"]]] call ExileServer_system_network_send_to;
					{playSound "addItemFailed"} remoteExec ["call",_player];
					continue;
				};
				...
				[_player, "toastRequest", ["InfoTitleAndText", ["[AeoG] Activity reward",format ["You received +%1 <img image='\exile_assets\texture\ui\poptab_inline_ca.paa' size='24'/><br/>You have now %2 <img image='\exile_assets\texture\ui\poptab_inline_ca.paa' size='24'/>", _amount, _newPlayerMoney]]]] call ExileServer_system_network_send_to;
